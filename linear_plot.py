...
titles = ('SB2_MB3,SB3_MB4,SB4_MB1,SB8_MB2,SB8A_MB2,SB11_MB6,SB12_MB7').split(',')
...
def linear_plots(modis_refs, sent_refs, cmap = cm.get_cmap('YlGnBu'), titles=titles, xlabel="MOD reflectance", ylabel='SEN reflectance',three_sigma=0):
    plot_config()
    fig = plt.figure()
